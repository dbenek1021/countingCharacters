...
function countingCharacters3(str, search) {
	...
	var lastIndex = str.length - numChars;     // Like the last example, we will use a for loop to go through our string     // This time, we are looking for a series of characters - a substring
